...
class Entity:
    ...
    def detach(self, cls: Type['Component']) -> None:
        """
    ...
    def get_component(self, cls: Type['Component']) -> Any:
        """
...
class TransformComponent(Component):
    def __init__(self, position: Vector2f, rotation: Vector3f = Vector3f(0, 0, 0), scale: Vector3f = Vector3f(1, 1, 1)):
        super(TransformComponent, self).__init__()
        self._position = position
        self._rotation = rotation
        self._scale = scale

    def get_transformation_matrix(self) -> Matrix4f:
        """
    ...
    def translate(self, new_position: Vector2f) -> None:
        """
    ...
    def rotate(self, new_rotation: Vector3f) -> None:
        """
    ...
    def scale(self, new_scale: Vector3f) -> None:
        """
...
class MaterialComponent(Component):
    def __init__(self, material: Material, sx: float, sy: float) -> None:
